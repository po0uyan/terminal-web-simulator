...
//general things to do for all comands before executing known commands
    ...
    //var node = document.createTextNode("user@pouyan.me:~$ "+command);
    para.innerHTML = "user@pouyanme:~$ "+command;
    ...
    if(command.toLowerCase() == "help"){
        ...
        var reslink = document.createTextNode("PouyanShalbafanResume.pdf");
        link.setAttribute('href', "http://pouyan.me/resume/PouyanShalbafanResume.pdf");
        ...
        "My name is Pouyan Shalbafan, I was born in 1993. Currently I'm studying M.Sc." +
            " in artificial intelligencee at the <a href='http://iut.ac.ir' target='_blank'> Isfahan University of technology</a>. <br>"+
            ...
            "<a href=\'mailto:p.shalbafan@ec.iut.ac.ir\' target='_blank'>p.shalbafan@ec.iut.ac.ir</a><br>" +
            "You can also check my <a href=\'http://linkedin.com/in/pouyan-shalbafan-614aa8101' target='_blank'>LinkedIn</a> profile or look at my resume to know more about my technical skills. <br>" +
            "For non-technical ones, we need to be friends in real life otherwise, just knowing that I like playing video games would be enough :)<br><br>";
        history.appendChild(par);
    }
      ...
      //  var par = document.createElement("p");
       ...
       // par.innerHTML = "Well I've done multiple projects that aren't visible online anymore. <br>" +
         //   "But here are the ones that are available: <br><br>" +
           // "<a href='http://petroninja.nansari.com' target='_blank'> Vogel IPR oil extraction:</a> For this one I " +
           ...
           // "<a href=\'https://github.com/enari/parallel-streaming-ParS\' target='_blank'>Parallel HTTP for video streaming on wireless networks:</a>" +
            ...
            //"<a href=\'https://github.com/nari/linux-terminal-web-page\' target='_blank'>This website's template:</a> " +
